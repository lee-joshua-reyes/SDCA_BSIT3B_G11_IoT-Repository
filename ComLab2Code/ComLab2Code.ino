...
// --------- SERVER ----------
const char* SERVER_IP = "192.168.254.103";           // ← CHANGE THIS to your server IP
const int SERVER_PORT = 3000;

// --------- DEVICE CONFIG ----------
const char* DEVICE_ID = "Computer-Laboratory-2"; // assign this scanner to a room
