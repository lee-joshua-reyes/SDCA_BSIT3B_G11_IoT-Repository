...
// --------- SERVER ----------
const char* SERVER_IP = "192.168.0.110";           // ← CHANGE THIS to your server IP
const int SERVER_PORT = 3000;

// --------- DEVICE CONFIG ----------
const char* DEVICE_ID = "Networking-Lab"; // assign this scanner to a room
